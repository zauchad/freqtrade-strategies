...
class E0V1E_53_Sharpe(IStrategy):
    # Optimized minimal ROI
    minimal_roi = {
        "0": 1
    }

    # Timeframe and other configurations
    timeframe = '5m'
    ...
    # Optimized stoploss and trailing stop
    stoploss = -0.15
    trailing_stop = True
    ...
    buy_cti_32 = DecimalParameter(-1, 1, default=-0.04, decimals=2, space='buy', optimize=True)
    buy_rsi_fast_32 = IntParameter(20, 70, default=65, space='buy', optimize=True)
    buy_rsi_32 = IntParameter(15, 50, default=19, space='buy', optimize=True)
    buy_sma15_32 = DecimalParameter(0.900, 1, default=0.961, decimals=3, space='buy', optimize=True)

    # Optimized sell parameters
    sell_fastx = IntParameter(50, 100, default=61, space='sell', optimize=True)
    sell_loss_cci = IntParameter(low=0, high=600, default=112, space='sell', optimize=True)
